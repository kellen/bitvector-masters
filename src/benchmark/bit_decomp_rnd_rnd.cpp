...
Benchmark::BitDecompRndRnd::BitDecompRndRnd(unsigned int* skip, int skipnum) : BenchmarkBit(skip, skipnum) {
...
void Benchmark::BitDecompRndRnd::name(std::ostream& out) const {
    out << "bitvector, decomp HC";
}
void Benchmark::BitDecompRndRnd::varsel(std::ostream& out) const {
    out << "RND";
}
void Benchmark::BitDecompRndRnd::shortname(std::ostream& out) const {
    out << "bitdecomphcrnd";
}
