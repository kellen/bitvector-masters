...
Benchmark::BitDecompNoneRnd::BitDecompNoneRnd(unsigned int* skip, int skipnum) : BenchmarkBit(skip, skipnum) {
...
void Benchmark::BitDecompNoneRnd::name(std::ostream& out) const {
    out << "bitvector, decomp HC";
}
void Benchmark::BitDecompNoneRnd::varsel(std::ostream& out) const {
    out << "NONE";
}
void Benchmark::BitDecompNoneRnd::shortname(std::ostream& out) const {
    out << "bitdecomphcnone";
}
