...
TestSBox::DisequalTest::DisequalTest() : FullTestBase(), v(*this, 2, TESTBITS) {
    disequal(*this, v[0], v[1]);
    Rnd r(1U);
    branch(*this, v, BIT_VAR_NONE(), BIT_VAL_RND_BIT(r));
}

TestSBox::DisequalTest::DisequalTest(bool share, DisequalTest& sb) : FullTestBase(share, sb) {
    v.update(*this, share, sb.v);
}

Space* TestSBox::DisequalTest::copy(bool share) {
    return new DisequalTest(share, *this);
}

bool TestSBox::DisequalTest::after(std::ostream& out) const {
    bool success = true;
