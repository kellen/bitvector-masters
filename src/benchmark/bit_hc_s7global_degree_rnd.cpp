...
Benchmark::BitHCS7DegreeRnd::BitHCS7DegreeRnd(unsigned int* skip, int skipnum) : BenchmarkBit(skip, skipnum) {
...
void Benchmark::BitHCS7DegreeRnd::name(std::ostream& out) const {
    out << "bitvector, HC, S7 global";
}
void Benchmark::BitHCS7DegreeRnd::varsel(std::ostream& out) const {
    out << "DEGREE";
}
void Benchmark::BitHCS7DegreeRnd::shortname(std::ostream& out) const {
    out << "bithcssevendegree";
}
