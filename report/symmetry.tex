...
The \sc{DES} criteria S-1 is already fulfilled by the choice of variables.
...
%Criteria S-4 is a constraint on pairs of variables whose inputs differ by a single bit. 
