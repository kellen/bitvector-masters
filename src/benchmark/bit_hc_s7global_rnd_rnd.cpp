...
Benchmark::BitHCS7RndRnd::BitHCS7RndRnd(unsigned int* skip, int skipnum) : BenchmarkBit(skip, skipnum) {
...
void Benchmark::BitHCS7RndRnd::name(std::ostream& out) const {
    out << "bitvector, HC, S7 global";
}
void Benchmark::BitHCS7RndRnd::varsel(std::ostream& out) const {
    out << "RND";
}
void Benchmark::BitHCS7RndRnd::shortname(std::ostream& out) const {
    out << "bithcssevenrnd";
}
