...
Benchmark::BitHCNoneRnd::BitHCNoneRnd(unsigned int* skip, int skipnum) : BenchmarkBit(skip, skipnum) {
...
void Benchmark::BitHCNoneRnd::name(std::ostream& out) const {
    out << "bitvector, HC";
}
void Benchmark::BitHCNoneRnd::varsel(std::ostream& out) const {
    out << "NONE";
}
void Benchmark::BitHCNoneRnd::shortname(std::ostream& out) const {
    out << "bithcnone";
}
